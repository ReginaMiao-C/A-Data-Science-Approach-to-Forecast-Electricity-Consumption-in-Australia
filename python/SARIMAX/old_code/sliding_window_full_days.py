...
This version stores the generated values at each 30 interval.
Statistics are not generated or stored.
"""
...
if __name__=="__main__":
    ...
    start = datetime.datetime(year=2017, month=1, day=1) - datetime.timedelta(days=training_window)
    start_dates = [start + datetime.timedelta(days=i) for i in list(range(0, 365*4, step))]
    ...
    df.to_csv(root_folder / "python" / "SARIMAX" / f"interval_data_with_exog{datetime.date.today()}.csv")
