...
var_dict_total = {'rainfall': 'Daily Rainfall (mm)', 'pv_capacity': 'PV Installation', 'temperature': 'Temperature (\u00b0C)', 'solar_power': r'Solar Irradiance (Wh m$^{-2}$)', 'total_demand': 'Total Electricity Demand (MW)'}
