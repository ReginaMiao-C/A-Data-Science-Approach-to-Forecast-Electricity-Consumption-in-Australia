...
def plot_resids(df, res_path, model_name, model):
    ...
    pred_colors = {model:'brown', 'AEMO':'salmon'}
...
if model == 'LSTM':
    ...
    plot_results(df_final, save_path, 'sarimax_test_full_year')
    plot_resids(resid_df, save_path, 'sarimax_test_full_year', model)
